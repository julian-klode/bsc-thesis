...
\lstinputlisting[firstline=29,lastline=30,frame=t,caption={Person, Employee, and Company representations in LIGD},label=src:ligd-company:stuff]{scala/src/ligd-company.scala}
...
\lstinputlisting[firstline=61,lastline=68,caption=Increase the salaries in LIGD,label=src:ligd-company:sumSalary]{scala/src/ligd-company.scala}
...
\lstinputlisting[firstline=76,lastline=84,caption=Summing salaries in Shapeless]{scala/src/shapeless.scala}
