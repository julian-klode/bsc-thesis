...
\lstinputlisting[firstline=250,lastline=266,label=src:ligd:Returning,caption=gshow in LIGD]{scala/src/ligd.scala}
We can now define another function accepting generic functions, for example, \cd{gmapQ}:
\lstinputlisting[firstline=275,lastline=281,label=src:ligd:Returning,caption=gshow in LIGD]{scala/src/ligd.scala}
