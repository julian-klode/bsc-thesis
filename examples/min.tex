...
\lstinputlisting[firstline=296,lastline=315,caption=Minimum in EMGM,label=src:emgm:gmin]{scala/src/emgm.scala}
...
integer for an integer value. The \cd{minimum} object then combines two values.
\lstinputlisting[firstline=59,lastline=67,caption=Minimum in Shapeless,label=src:shapeless:min]{scala/src/shapeless.scala}
