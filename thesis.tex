...
\begin{document}
    ...
    \lstinputlisting[language=scala,firstline=55,lastline=70,float=ht,caption=LIGD Basics,label=ligd-base]{scala/src/ligd.scala}
    ...
    implemented.
    \lstinputlisting[language=scala,firstline=78,lastline=97,float=ht,caption=Implementation of RType,label=ligd-rtype]{scala/src/ligd.scala}
    ...
    \lstinputlisting[language=scala,firstline=103,lastline=124,float=ht,caption=Implementation of rList,label=ligd-rlist]{scala/src/ligd.scala}
    ...
    and then pattern match on the type representations.
      ...
      \lstinputlisting[language=scala,firstline=37,lastline=52,float=ht,caption=Generic Equality in LIGD,label=ligd-geq]{scala/src/ligd.scala}
