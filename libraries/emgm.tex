...
\lstinputlisting[firstline=252,lastline=269,float=ht,label=src:emgm:GEqList,caption=Generic equality specialised to lists]{scala/src/emgm.scala}
...
\lstinputlisting[firstline=233,lastline=236,label=src:emgm:GRProd,caption=Example of a \cd{GRep} instance: \cd{GRProd}]{scala/src/emgm.scala}

We can now add a representation for our special case of lists:

\lstinputlisting[firstline=244,lastline=247,label=src:emgm:GRList,caption=Example of a \cd{GRep} instance: \cd{GRList}]{scala/src/emgm.scala}
