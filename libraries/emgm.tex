...
\lstinputlisting[language=scala,firstline=240,lastline=242,label=src:emgm:GenericList,caption=Generic with ad-hoc list case,showstringspaces=false]{scala/src/emgm.scala}
