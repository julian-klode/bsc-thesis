...
implemented.
\lstinputlisting[firstline=75,lastline=88,float=ht,caption=Implementation of RType,label=ligd-rtype]{scala/src/ligd.scala}
...
%\lstinputlisting[firstline=102,lastline=106]{scala/src/ligd.scala}

\lstinputlisting[firstline=94,lastline=115,float=ht,caption=Implementation of rList,label=ligd-rlist]{scala/src/ligd.scala}
