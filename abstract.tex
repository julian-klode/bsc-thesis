...
über die Struktur eines Datentypes zu definieren, anstelle von eines spezifischen
...
von Funktionen löse, welches bisherige Implementierungen stark beeinträchtige.
\end{abstract}
...
solving the issue with extensibility and that made it vastly inferior in previous
implementations.
